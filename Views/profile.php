    ...
    <div class="side">
      <div class="side-inner">
        <ul class="nav flex-column">
          ...
          data-bs-content="<a href='profile.php'>プロフィール</a><br>
        <a href='sign-out.php'>ログアウト</a>"></li>
        </ul>
      </div>
    </div>
    <div class="main">
      ...
      <div class="profile-area">
        <div class="top">
          ...
          <butten class="btn btn-reverse btn-sm">プロフィール編集</butten>
        </div>

        <div class="name">太郎</div>
        <div class="test-muted">@taro</div>
        <div class="follow-forrower">
          <div class="follow-count">1</div>
          <div class="follow-text">フォロー中</div>
          <div class="follow-count">1</div>
          <dov class="forrow-count">フォロワー</dov>
        </div>
      </div>
      <!--仕切り-->
      <div class="ditch"></div>
